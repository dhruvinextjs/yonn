      ...
      <div className="relative container mx-auto px-6 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <Link
            ...
            className="flex items-center justify-center gap-1 px-14 py-6 text-white bg-[#660066] text-2xl font-bold hover:bg-transparent hover:border hover:border-white transition duration-300"
          >
